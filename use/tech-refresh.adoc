...
+
TIP: You can access this feature either through BlueXP economic efficiency or through NetApp Digital Advisor. This first step indicates how to access the option through BlueXP economic efficiency. 
+
