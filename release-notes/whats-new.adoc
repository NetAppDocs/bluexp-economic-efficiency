...
If you have existing assets in place and want to determine whether a technology refresh is recommended, you can use the BlueXP economic efficiency Tech refresh options. You can either review a short assessment of your current workloads and get recommendations, or now if you have sent AutoSupport logs to NetApp within the past 90 days, the service can provide a workload simulation to see how your workloads perform on new hardware.
